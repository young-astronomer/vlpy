...
def cc2tex(infile, outfile='', dx=4.0, dy=1.0, theta=45.0, domodel=0):
	# Read AIPS CC table
...
def main(argv):
	...
	try:
		opts, args = getopt.getopt(argv, "hi:o:x:y:t:d:", ['help', 'infile=', 'outfile=', 'dx=', 'dy=', 'theta=', 'domodel='])
	...
	cc2tex(infile, outfile, dx, dy, theta, domodel)
